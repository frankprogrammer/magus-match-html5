...
export const HUD_SCORE_VALUE_FONT_SIZE = 44;
export const HUD_SCORE_VALUE_MIN_FONT_SIZE = 24;
...
export const HUD_TRIAL_ENEMY_COUNT_ICON_HEIGHT = HUD_HEART_DISPLAY_HEIGHT;
export const HUD_TRIAL_ENEMY_COUNT_ICON_WIDTH =
  (HUD_TRIAL_ENEMY_COUNT_ICON_HEIGHT * HUD_TRIAL_FILLBAR_KOBOLD_NATURAL_SIZE.width) /
  HUD_TRIAL_FILLBAR_KOBOLD_NATURAL_SIZE.height;
export const HUD_TRIAL_ENEMY_COUNT_RIGHT_SHIFT_PX = 100;
export const HUD_TRIAL_ENEMY_COUNT_ICON_X =
  HUD_TRIAL_FILLBAR_LEFT_X + HUD_TRIAL_ENEMY_COUNT_RIGHT_SHIFT_PX;
export const HUD_TRIAL_ENEMY_COUNT_ICON_Y =
  HUD_BAND_TOP_Y + (HUD_HEIGHT - HUD_TRIAL_ENEMY_COUNT_ICON_HEIGHT) / 2;
export const HUD_TRIAL_ENEMY_COUNT_COLON_GAP = 2;
export const HUD_TRIAL_ENEMY_COUNT_COLON_X =
  HUD_TRIAL_ENEMY_COUNT_ICON_X +
  HUD_TRIAL_ENEMY_COUNT_ICON_WIDTH +
  HUD_TRIAL_ENEMY_COUNT_COLON_GAP;
export const HUD_TRIAL_ENEMY_COUNT_COLON_WIDTH = 24;
export const HUD_TRIAL_ENEMY_COUNT_VALUE_GAP = 8;

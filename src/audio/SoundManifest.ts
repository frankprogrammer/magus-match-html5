...
export const SoundManifest = {
  ...
  [AssetIds.sounds.matchCoin]: spellAttackWhoosh(
    ...
    'Score coin on match resolve with merge; Coin.ogg in public/assets/audio.',
  ),
  ...
  [AssetIds.sounds.fireWhoosh]: spellAttackWhoosh(
    ...
    'Fire spell launch; Attack_Fire.ogg in public/assets/audio.',
  ),
  [AssetIds.sounds.iceWhoosh]: spellAttackWhoosh(
    ...
    0.38,
    synth('sine', 620, 120),
    'Ice spell launch; Attack_Freeze.ogg in public/assets/audio.',
  ),
  [AssetIds.sounds.lightningWhoosh]: spellAttackWhoosh(
    AssetIds.sounds.lightningWhoosh,
    'Attack_Lightning.ogg',
    'spell',
    'templateLocal',
    0.38,
    synth('square', 740, 75),
    'Lightning spell launch; Attack_Lightning.ogg in public/assets/audio.',
  ),
  [AssetIds.sounds.earthWhoosh]: spellAttackWhoosh(
    ...
    'Earth spell launch; Attack_Earth.ogg in public/assets/audio.',
  ),
  ...
  [AssetIds.sounds.monsterDefeat]: spellAttackWhoosh(
    ...
    0.54,
    synth('noise', 140, 170),
    'Monster defeat; Die_Enemy.ogg in public/assets/audio.',
  ),
  ...
  [AssetIds.sounds.playerDefeat]: spellAttackWhoosh(
    ...
    0.56,
    synth('noise', 160, 220),
    'Trial mage defeated; Die_Player.ogg in public/assets/audio.',
  ),
  ...
  [AssetIds.sounds.powerupBombActivate]: spellAttackWhoosh(
    ...
    'TNT tap or swap activation; Activarion_Bomb.ogg in public/assets/audio.',
  ),
  [AssetIds.sounds.powerupRocketActivate]: spellAttackWhoosh(
    ...
    'Rocket row/column tap or swap activation; Activation_Star.ogg in public/assets/audio.',
  ),
  ...
  [AssetIds.sounds.musicBackground]: spellAttackWhoosh(
    ...
    0.22,
    synth('sine', 196, 2000),
    'Quiet looping session BGM; Background.ogg in public/assets/audio.',
  ),
